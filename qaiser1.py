...
\ \  \\\  \ \  \|\  \ \  \___| \|___/  /\ \  \|\  \   
 \ \   __  \ \   __  \ \  \        /  / /\ \   _  _\  
  \ \  \ \  \ \  \|\  \ \  \____  /  /_/__\ \  \\  \| 
   \ \__\ \__\ \_______\ \_______\\________\ \__\\ _\ 
    \|__|\|__|\|_______|\|_______|\|_______|\|__|\|__|
                                                                                                          
                                                      
\n\033[0m-----------------------------------------------------
\033[1;92mName \033[1;93m: ANO NYM OUS
\033[1;92myoutbe\033[1;93m: EDITZ Z6 GFX
...
def main():
    ...
    print ' \033[0m[2].\x1b[1;96m Follow editz channel '
    print ' \033[0m[3].\x1b[1;96m New Hacking channel '
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://youtube.com/channel/UC6SVro-gH45JN1Uld6rlmqg')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://youtube.com/channel/UChbXbMUaZrdUnTz_97xqEsQ' )
        main()
    else:
        print ''
